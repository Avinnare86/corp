...
class Audit
{
    ...
    private static array $labels = [
        ...
        // График отпусков (документ)
        '#^/vacation-schedule$#'                  => 'График отпусков: создание',
        '#^/vacation-schedule/\d+/row$#'          => 'График отпусков: добавлен период',
        '#^/vacation-schedule/\d+/row/\d+/delete$#'=> 'График отпусков: удалён период',
        '#^/vacation-schedule/\d+/row-status$#'   => 'График отпусков: согласование периодов',
        '#^/vacation-schedule/\d+/balance$#'      => 'График отпусков: остаток сотрудника',
        '#^/vacation-schedule/\d+/sign$#'         => 'График отпусков: подписан',
        '#^/vacation-schedule/\d+/archive$#'      => 'График отпусков: в архив',
        '#^/vacation-schedule/\d+/delete$#'       => 'График отпусков: удалён',
        // Командировки
        '#^/trips$#'                              => 'Командировка: сохранение заявки',
        '#^/trips/\d+/segment#'                   => 'Командировка: сегмент пребывания',
        '#^/trips/\d+/extra#'                     => 'Командировка: доп.расход',
        '#^/trips/\d+/upload$#'                   => 'Командировка: вложение',
        '#^/trips/\d+/attachment/\d+/delete$#'    => 'Командировка: удаление вложения',
        '#^/trips/\d+/submit$#'                   => 'Командировка: подана на согласование',
        '#^/trips/\d+/approve$#'                  => 'Командировка: согласована директором',
        '#^/trips/\d+/reject$#'                   => 'Командировка: возврат на доработку',
        '#^/trips/\d+/fact$#'                     => 'Командировка: факт расходов',
        '#^/trips/\d+/archive$#'                  => 'Командировка: в архив',
        '#^/trips/\d+/delete$#'                   => 'Командировка: удалена',
        '#^/trip-finance/budget$#'                => 'Командировки: бюджет (финансы)',
        '#^/trip-finance/per-diem$#'              => 'Командировки: суточные (финансы)',
        '#^/trip-finance/kind#'                   => 'Командировки: справочник расходов',
        // Электронная подпись (профиль)
        '#^/certs/issue$#'                        => 'ЭП: выпуск УКЭП через сервис',
        '#^/tariff-coeff/save$#'            => 'Тариф анкет: дневной коэффициент',
        ...
        '#^/shifts/grafik/sign$#'           => 'График сменности 2/2: ПОДПИСАНИЕ ЭП',
        '#^/shifts/grafik/archive$#'        => 'График 2/2: перенос в архив',
        '#^/shifts/grafik/unarchive$#'      => 'График 2/2: возврат из архива',
        '#^/shifts/grafik/delete$#'         => 'График 2/2: БЕЗВОЗВРАТНОЕ удаление (админ)',
        '#^/timesheet2/\d+/delete$#'        => 'Эл. табель: удаление',
        '#^/timesheet2/\d+/archive$#'       => 'Эл. табель: перенос в архив',
        '#^/timesheet2/\d+/unarchive$#'     => 'Эл. табель: возврат из архива',
        '#^/shifts/grid$#'                  => 'Сменный график (2/2): сохранение таблицы Д/Н',
        '#^/shifts/standard$#'              => 'Сменный график (2/2): стандартные времена смен',
        '#^/shifts/employee/save$#'         => 'Сменный график (2/2): индивидуальные времена сотрудника',
        '#^/shifts/employee/days$#'         => 'Сменный график (2/2): переопределение дней / факт',
        ...
        '#^/memos/\d+/reject-final$#'              => 'Стимул: окончательное отклонение → архив',
        '#^/memos/\d+/unarchive$#'                 => 'Стимул: возврат из архива на доработку',
        '#^/memos/\d+/delete$#'                    => 'Стимул: удаление служебки',
