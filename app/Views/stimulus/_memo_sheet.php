<?php
/**
 * Партиал одной служебки (А4-лист со штампами ЭП). Используется print.php (одна) и
 * print_batch.php (много, в цикле). Ожидает в области видимости хелперы $months,$monthsG,$stamp,$pctf
 * и данные: $memo,$lines,$kind,$source,$directorName,$grounds,$groundRows,$signers.
 */
...
$grounds = $grounds ?? array_map(fn($g) => $g['text'], $groundRows ?? []);
